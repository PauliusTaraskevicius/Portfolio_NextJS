      ...
      <div className="flex items-center justify-center min-h-screen mt-20">
        <div className="p-5 w-10/12 lg:w-3/6">
          <div className="mt-4 mb-6">
            <div className="textColorChange mb-3 text-xl font-bold">
              <h2>Terms and Conditions</h2>
            </div>
            <div className="textTermsPrivacy text-lg  space-y-6">
              <p>
                These terms and conditions outline the rules and regulations for
                the use of Paulius Taraškevičius Website, located at
                manosaitas.com.
              </p>
              <p>
                By accessing this website we assume you accept these terms and
                conditions. Do not continue to use Paulius Taraškevičius if you
          ...
          <div className="mt-12 mb-6">
            ...
            <div className="textTermsPrivacy text-lg  space-y-6">
              <p>
                We employ the use of cookies. By accessing Paulius
                Taraškevičius, you agreed to use cookies in agreement with the
                Paulius Taraškevičius Privacy Policy.
              </p>
              <p>
          ...
          <div className="mt-12 mb-6">
            ...
            <div className="textTermsPrivacy text-lg  space-y-6">
              <p>
                Unless otherwise stated, Paulius Taraškevičius and/or its
                licensors own the intellectual property rights for all material
                on Paulius Taraškevičius. All intellectual property rights are
                reserved. You may access this from Paulius Taraškevičius for
              ...
              <ul className="list-disc pl-8 ">
                <li className="pb-3">
                  Republish material from Paulius Taraškevičius
                </li>
                <li className="pb-3">
                  Sell, rent or sub-license material from Paulius Taraškevičius.
                </li>
                <li className="pb-3">
                  Reproduce, duplicate or copy material from Paulius
                  Taraškevičius
                </li>
                <li className="pb-3">
                  Redistribute content from Paulius Taraškevičius
                </li>
              </ul>
              <p>
                Parts of this website offer an opportunity for users to post and
                exchange opinions and information in certain areas of the
                website. Paulius Taraškevičius does not filter, edit, publish or
                review Comments prior to their presence on the website. Comments
                do not reflect the views and opinions of Paulius
                Taraškevičius,its agents and/or affiliates. Comments reflect the
                views and opinions of the person who post their views and
                opinions. To the extent permitted by applicable laws, Paulius
                Taraškevičius shall not be liable for the Comments or for any
              ...
              <p>
                Paulius Taraškevičius reserves the right to monitor all Comments
              ...
              <p>
                You hereby grant Paulius Taraškevičius a non-exclusive license
          ...
          <div className="mt-12 mb-6">
            ...
            <div className="textTermsPrivacy text-lg  space-y-6">
              ...
              <ul className="list-disc pl-8 ">
                ...
                <li className="pb-3">Search engines;</li>
                <li className="pb-3">News organizations;</li>
                <li className="pb-3">
              ...
              <ul className="list-disc pl-8 ">
                ...
                <li className="pb-3">dot.com community sites;</li>
                <li className="pb-3">
                  associations or other groups representing charities;
                </li>
                <li className="pb-3">online directory distributors;</li>
                <li className="pb-3">internet portals;</li>
                <li className="pb-3">
              ...
              <p>
                ...
                of Paulius Taraškevičius and (d) the link is in the context of
              ...
              <p>
                ...
                by sending an e-mail to Paulius Taraškevičius. Please include
              ...
              <ul className="list-disc pl-8 ">
                <li className="pb-3">By use of our corporate name; or</li>
                <li className="pb-3">
              ...
              <p>
                No use of Paulius Taraškevičius logo or other artwork will be
