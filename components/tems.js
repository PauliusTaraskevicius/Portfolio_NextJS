    ...
    <div className="flex items-center justify-center min-h-screen mt-20">
      <div className="p-5 w-10/12 lg:w-3/6">
        <div className="mt-4 mb-6">
          ...
          <div className="textTermsPrivacy text-lg  space-y-6">
            ...
            <p>
              ...
              conditions. Do not continue to use Paulius Taraškevičius if you do
        ...
        <div className="mt-12 mb-6">
          ...
          <div className="textTermsPrivacy text-lg  space-y-6">
            <p>
              We employ the use of cookies. By accessing Paulius Taraškevičius,
              you agreed to use cookies in agreement with the Paulius
              Taraškevičius Privacy Policy.
            </p>
            <p>
        ...
        <div className="mt-12 mb-6">
          ...
          <div className="textTermsPrivacy text-lg  space-y-6">
            <p>
              ...
              Paulius Taraškevičius. All intellectual property rights are
              reserved. You may access this from Paulius Taraškevičius for your
            ...
            <ul className="list-disc pl-8 ">
              ...
              <li className="pb-3">
                Reproduce, duplicate or copy material from Paulius Taraškevičius
              </li>
              <li className="pb-3">
            ...
            <p>
              ...
              Paulius Taraškevičius does not filter, edit, publish or review
              Comments prior to their presence on the website. Comments do not
              reflect the views and opinions of Paulius Taraškevičius,its agents
              ...
              by applicable laws, Paulius Taraškevičius shall not be liable for
            ...
            <p>
              You hereby grant Paulius Taraškevičius a non-exclusive license to
        ...
        <div className="mt-12 mb-6">
          ...
          <div className="textTermsPrivacy text-lg  space-y-6">
            ...
            <p>
              ...
              Paulius Taraškevičius and (d) the link is in the context of
            ...
            <p>
              ...
              by sending an e-mail to Paulius Taraškevičius. Please include your
