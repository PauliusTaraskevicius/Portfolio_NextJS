      ...
      <div className="p-5 w-10/12 lg:w-3/6">
        <div className="mt-4 mb-6">
          <div className="textColorChange mb-3 text-2xl font-bold">
            <h2>Privacy Policy for Paulius Taraškevičius</h2>
          </div>
          <div className="textTermsPrivacy text-lg  space-y-6">
            <p>
              One of our main priorities is the privacy of our visitors. This
              Privacy Policy document contains types of information that is
              collected and recorded by Paulius Taraškevičius and how we use it.
            </p>
            <p>
        ...
        <div className="mt-12 mb-6">
          ...
          <div className="textTermsPrivacy text-lg  space-y-6">
            ...
            <ul className="list-disc pl-8 ">
              ...
              <li className="pb-3">Send you emails</li>
              <li className="pb-3">Find and prevent fraud</li>
            </ul>
          </div>
        </div>
        <div className="mt-12 mb-6">
          ...
          <div className="textTermsPrivacy text-lg  space-y-6">
            <p>
              Paulius Taraškevičius follows a standard procedure of using log
        ...
        <div className="mt-12 mb-6">
          ...
          <div className="textTermsPrivacy text-lg  space-y-6">
            <p>
              Like any other website, Paulius Taraškevičius uses 'cookies'.
        ...
        <div className="mt-12 mb-6">
          ...
          <div className="textTermsPrivacy text-lg  space-y-6">
            <p>
              ...
              the advertising partners of Paulius Taraškevičius.
            </p>
            <p>
              Third-party ad servers or ad networks uses technologies like
              cookies, JavaScript, or Web Beacons that are used in their
              respective advertisements and links that appear on Paulius
              Taraškevičius, which are sent directly to users' browser. They
            ...
            <p>
              Note that Paulius Taraškevičius has no access to or control over
        ...
        <div className="mt-12 mb-6">
          ...
          <div className="textTermsPrivacy text-lg  space-y-6">
            <p>
              Paulius Taraškevičius Privacy Policy does not apply to other
        ...
        <div className="mt-12 mb-6">
          ...
          <div className="textTermsPrivacy text-lg  space-y-6">
            ...
            <p>
              Paulius Taraškevičius does not knowingly collect any Personal
